	...
	<div id="userBox">
		<h2>
			<a style="text-decoration: none;"
				href="../user.jsp?id=<%= users.getString("id_user")  %>">
		...
		<form method="post" class="edit-form" action="EditUser">
			...
			<input name="username" type="text"
				value="<%= users.getString("name") %>"> <input name="email"
				type="text" value="<%= users.getString("email") %>"> <input
				name="id" type="hidden" value="<%= users.getString("id_user") %>">
