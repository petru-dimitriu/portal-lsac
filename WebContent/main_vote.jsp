...
<link rel="stylesheet" type="text/css"
	href="style/css/style_headers.css">
<link rel="stylesheet" type="text/css" href="style/css/styleVotes.css">
<%@page
	import="com.tip.connection.SqlConnection, java.sql.*, java.util.*, com.tip.data.*"%>
...
<div id="innerBody">
	...
	<script>
		...
		function voteFor(pollId, ansId) {
			...
			xhttp.open("GET", "RegisterVote?id_poll=" + pollId + "&id_ans="
					+ ansId, true);
			xhttp.send();
		}
	</script>
	...
	<div class="poll" id="poll<%=idSondaj%>">
		<div id="rightFloater">
			AMR: <span id="stop<%=indexSondaj%>"> </span> <br>
			<span class="msg" id="msg<%=idSondaj%>"></span>
		</div>
		<h1>
			<%
		...
		%>
		<div class="option">
			<a href="javascript:voteFor(<%=idSondaj%>,<%=i%>)">
				<%
					out.println(option);
				%>
			</a>
